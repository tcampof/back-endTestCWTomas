...
namespace back_endTestCWTomas.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public async Task<ActionResult<Usuarios>> GetUsuarios(string nombre, string password)
        {
            var usuarios = await _context.usuarios.FirstOrDefaultAsync(x => x.Nombre == nombre && x.password == password);
